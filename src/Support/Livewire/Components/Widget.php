...
abstract class Widget implements Wireable
{
     ...
     * @param  array $options
     */
    public static function make($identifier = null, array $options = [])
    {
    ...
    {
        // dd(Str::of($this->widgetName)->kebab()->lower()->finish("-{$this->wireModelName}")->toString(), $name, $params);
