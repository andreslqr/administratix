    ...
    <aside class="bg-base-200 w-80">
        ...
        <x-dynamic-component :component="config('administratix.views.components.menu.view')" class="p-2 pl-0">
            @foreach($this->items as $item)
                <x-dynamic-component :component="config('administratix.views.components.menu.item.view')" class="hover-bordered" anchor-class="rounded-l-none active:!rounded-l-none !rounded-r-full" active> 
                    @if($item->getIconName())
